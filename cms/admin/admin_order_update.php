...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto w-50">
        ...
        <?php 
            ...
            $orh_id = $_GET["orh_id"];
            $query = "SELECT orh.orh_refcode,orh.orh_ordertime,c.c_firstname,c.c_lastname,orh.orh_orderstatus,orh.orh_pickuptime,p.f_price,s.s_name
                FROM order_header orh INNER JOIN customer c ON orh.c_id = c.c_id INNER JOIN food p ON p.s_id = orh.s_id 
        ...
        <form method="POST" action="admin_order_update.php" class="form-floating">
            ...
            <div class="form-floating mb-2">
                <input type="text" class="form-control" id="ordercost" placeholder="Order Cost" value="<?php echo $row["f_price"]." ₹";?>" disabled>
