...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin mt-auto">
        ...
        <form method="POST" action="check_login.php" class="form-floating">
            ...
            <a class="nav nav-item text-decoration-none text-muted mb-2 small" href="admin/admin_login.php">
                <i class="bi bi-shop me-2"></i>ADMIN LOGIN
            </a>
            ...
            <a href="admin/admin_login.php" class="text-decoration-none text-light"></a>
    ...
    <footer
        ...
        <!-- <span class="smaller-font"><br /><span class="xsmall-font"><a href="admin/admin_login.php" class="text-decoration-none text-light">ADMIN LOGIN</a> </span></span>
