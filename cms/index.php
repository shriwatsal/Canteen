...
<body class="d-flex flex-column h-100">
    ...
    <div class="position-relative d-flex text-center text-white promo-banner-bg py-3">
        <div class="p-lg-2 mx-auto my-5">
            <h1 class="display-5 fw-normal">Welcome to PICT</h1>
            <p class="lead fw-normal">Canteen Management System PICT</p>
            <span class="xsmall-font text-muted">Eat Healty Food</span>
        </div>
    </div>
